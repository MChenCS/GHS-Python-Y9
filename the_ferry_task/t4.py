...
def calculate_sailing_price():
	"""Calculates and displays the price payable for sailing tickets, including vehicle fees and night sailing surcharge, in the user's preferred currency."""
	...
	total_price_gbp = ticket_price_gbp + vehicle_total_fee_gbp
