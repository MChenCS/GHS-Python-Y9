def calculate_sailing_price():
    """Calculates and displays the price payable for sailing tickets, including vehicle fees, in the user's preferred currency."""
    ...
    total_price_gbp = (base_fare_gbp * multiplier * num_tickets) + vehicle_total_fee_gbp
