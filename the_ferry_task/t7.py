...
def calculate_sailing_price():
	"""Calculates and displays the price payable for sailing tickets, including vehicle fees, night sailing surcharge, cabin costs, and return journey discount, in the user's preferred currency."""
